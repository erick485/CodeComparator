...
(function (i, O, l, n) {
    var j = function (e) {
        function o(a, b) {
            ...
            a.aoColumns.push(c);
            if (a.aoPreSearchCols[d] === n || null === a.aoPreSearchCols[d])a.aoPreSearchCols[d] = i.extend({}, j.models.oSearch); else if (c = a.aoPreSearchCols[d], c.bRegex === n && (c.bRegex = !0), c.bSmart === n && (c.bSmart = !0), c.bCaseInsensitive === n)c.bCaseInsensitive = !0;
            r(a, d, null)
        }
    ...
    j.defaults = {aaData: null, aaSorting: [
        ...
        fnStateSave: function (e, i) {
            ...
            sInfo: "Mostrando del _START_ al _END_ de las _TOTAL_ entradas", sInfoEmpty: "Showing 0 to 0 of 0 entries", sInfoFiltered: "(Filtrados  de  _MAX_ entradas totales)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "Show _MENU_ entries", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "", sUrl: "", sZeroRecords: "No matching records found"}, oSearch: i.extend({}, j.models.oSearch), sAjaxDataProp: "aaData", sAjaxSource: null, sCookiePrefix: "SpryMedia_DataTables_", sDom: "lfrtip", sPaginationType: "two_button", sScrollX: "",
